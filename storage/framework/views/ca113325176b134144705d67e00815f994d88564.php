...
<script src="<?php echo e(asset('js/nba.js')); ?>" defer></script>
<!-- Serve per la fetch nel js. Accertarsi di usarlo -->
<script type="text/javascript">
    const NBA_ROUTE = "<?php echo e(url('nba')); ?>";  
</script>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('style'); ?>
<link rel='stylesheet' href="<?php echo e(asset('css/nba.css')); ?>">
<?php $__env->stopSection(); ?>
